...
![image-20220705112829318](images/image-20220705112829318.png)
...
如果传入 ref 的是一个对象，将调用 `reactive` 方法对内部的value进行深层响应转换。
...
![composition API2](images/composition API2.gif)
